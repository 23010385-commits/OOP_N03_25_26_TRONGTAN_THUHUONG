...
public class HocVienService {
   ...
   * - Kiểm tra trùng bằng truy vấn trên bảng trung gian
  ...
  public String dangKyKhoaHoc(Long hocVienId, Long khoaHocId) {
    if (hocVienId == null || khoaHocId == null) {
      throw new IllegalArgumentException("HocVienId và KhoaHocId không được null");
    }
    ...
    if (daDangKy) {
      return "Học viên đã đăng ký khóa học này rồi!";
    }
    ...
    return "Đăng ký thành công: " + hocVien.getTen() + " -> " + khoaHoc.getTenKhoaHoc();
  }
